  ...
  return (
    <>
      <div className="flex items-center justify-between md:mt-14 mt-8 md:pr-0 pr-4">
        <p className="md:text-2xl text-xl">Podcasts</p>
        <p className="text-sm text-gray-400">See all</p>
      </div>
      <div className="overflow-x-auto  w-full mt-6">
        <div className="grid grid-rows-3 grid-flow-col gap-4  auto-cols-[270px] md:auto-cols-[300px] scrollbar-thin scrollbar-thumb-gray-400">
